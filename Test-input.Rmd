...
This data product extract the data from the mtcars database, and enable you to create plots from this data table. Use the navbar to access these tools.
...
Here is the link for the code of this app on github.
https://github.com/AugustinJossa/Data-product-mtcars
